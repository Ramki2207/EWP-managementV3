...
const navItems = [
  ...
  { path: '/verlof-meldingen', icon: Bell, label: 'Meldingen', module: 'worksheets' as SystemModule },
  { path: '/meldingen', icon: Wrench, label: 'EWP Services', module: 'meldingen' as SystemModule },
