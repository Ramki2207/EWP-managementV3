...
const navItems = [
  ...
  { path: '/my-worksheet', icon: FileText, label: 'Mijn Weekstaat', module: undefined },
  { path: '/worksheet-management', icon: ClipboardList, label: 'Weekstaat Beheer', module: 'worksheets' as SystemModule },
